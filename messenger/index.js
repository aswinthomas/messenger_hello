...
exports.handler = async function(event, context) {
  ...
  if (event.queryStringParameters) {
    ...
    if (body.object === "page") {
      ...
      const url = "https://graph.facebook.com/v16.0/" + recipient_psid + "/messages";
      ...
      console.log("MESSAGING EVENT_RECEIVED");
      return {
        statusCode: 200,
        body: "MESSAGING EVENT_RECEIVED",
      };
    } else {
...
function handleMessage(sender_psid, recipient_psid, received_message) {
  ...
  if (received_message.text) {
    ...
    msg = {
      text: `I hear you when you say "${received_message.text}". Now send me an image.`,
    };
